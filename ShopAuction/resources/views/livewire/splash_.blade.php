<div>
    ...
    <div class="flex select-none flex-row gap-1 rounded-md sm:flex-col">
        ...
        <div class="flex h-auto center px-2 rounded-2xl">
            <button class="w-auto px-6 rounded-md bg-teal-600 h-8 text-black hover:bg-teal-400">Apply</button>
        </div>
    </div>

    <div class="bg-white-500 grid grid-cols-5 xl:grid-cols-4 sm:flex-col gap-4 p-2">
        ...
        @for ($i = 0; $i < 15; $i++)
            <div class="col-span-1">
                <div class="grid grid-flow-row gap-2 rounded-lg border-2 border-teal-400 p-2">
                    ...
                    <div class="">
                        <img src="https://images.unsplash.com/photo-1488998427799-e3362cec87c3" alt=""
                            title="" />
                    </div>
